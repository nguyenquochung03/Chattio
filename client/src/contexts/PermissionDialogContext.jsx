...
import { Lock, Mic, Security, Videocam } from "@mui/icons-material";
import {
  Typography,
  Dialog,
  DialogContent,
      ...
      <Dialog open={openDialog} onClose={close}>
        ...
        <DialogContent>
          <Typography variant="body1">
            Để tham gia cuộc gọi thoại/video hoặc ghi âm, bạn cần cấp quyền sử
            dụng{" "}
            <strong>
              <Mic
                fontSize="small"
            ...
            đối với ghi âm. Đối với gọi video hoặc gọi thoại, bạn phải cho phép
            cả{" "}
            <strong>
              <Videocam
                fontSize="small"
            ...
            . Nếu không, bạn sẽ không thể tiếp tục.
          </Typography>
          <Typography
            variant="body2"
            color="textSecondary"
